...
server_tcb_t* server_tcb[server_tcb_size];//tcb array
int gSockFd;//global sockfd
...
//这是由seghandler在CONNECTED状态启动的线程. 它先睡100ms，然后将当前tcb状态转为CLOSED
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
